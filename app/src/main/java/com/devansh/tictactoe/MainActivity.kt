...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun checkWinner() {
            ...
            if(boardStatus[i][0]==boardStatus[i][1] &&
               boardStatus[i][0]==boardStatus[i][2]){
                if(boardStatus[i][0]==1){
                    updateDisplay("Player X has Won")
                    break
                }else if(boardStatus[i][0]==0){
                    updateDisplay("Player O has Won")
                    break
                }
            }
        }
        ...
        //Checking Rev Diagonals
        for(i in 0..2){
            if(boardStatus[0][2]==boardStatus[1][1] &&
                    boardStatus[2][0]==boardStatus[0][2]){
